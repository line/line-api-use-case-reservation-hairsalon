<template>
    <v-app>
        <img
            src="https://media.istockphoto.com/photos/beauty-saloon-interior-visualization-3d-illustration-picture-id1065779636"
            alt="Hairsalon"
            style="width: 100%"
        />
        ...
        <v-footer fixed style="" class="pa-0" height="60px">
            <v-btn class="basket text-h5 font-weight-bold" color="#00B900" v-on:click="reserve" style="color: #fff; width: 100%; height: 100%">
